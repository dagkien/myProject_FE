  ...
  return (
    <div className="container_home">
      <div class="container" x-data="{ rightSide: false, leftSide: false }">
        <div class="left-side" className="{'active' : leftSide}">
          <div class="left-side-button" onClick="leftSide = !leftSide">
            <svg
              viewBox="0 0 24 24"
              stroke="currentColor"
              stroke-width="2"
        ...
        <div class="main">
          <div class="search-bar">
            ...
            <button class="right-side-button" onClick="rightSide = !rightSide">
              <svg
                viewBox="0 0 24 24"
                width="24"
                height="24"
      ...
      <div class="right-side" className="{ 'active': rightSide }">
        <div class="account">
      ...
      <div
        class="overlay"
        onClick="rightSide = false; leftSide = false"
