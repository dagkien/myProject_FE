...
const Home = () => {
  ...
  const [checkOverlay, setOverlay] = useState("right");

  const handleOpenSideRight = () => {
    setSideRight(!checkSideRight);
    setOverlay("right");
  };
  const handleOpenSideLeft = () => {
  ...
  return (
    <body className="body_home">
      <div className="container_home">
        <div className="container" x-data="{ rightSide: true, leftSide: true }">
          <div className={checkSideLeft ? "left-side" : "left-side active"}>
            {/* <div className="left-side" className="{'active' : leftSide}"> */}
            <div className="left-side-button" onClick={handleOpenSideLeft}>
              <svg
                viewBox="0 0 24 24"
                stroke="currentColor"
                stroke-width="2"
                  ...
                  <div className="intro box">
                    ...
                    <div className="info">
                      ...
                      <div className="info-item">
                        ...
                        Player name <a href="#abc">FPT POLYTECHNIC</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="status box">
                    ...
                    <div className="status-main">
                      ...
                      <textarea
                        ...
                        placeholder="Write something to FPT POLYTECHNIC.."
                      ></textarea>
                    </div>
                    ...
                    <div className="status-main">
                      ...
                      <div className="album-detail">
                        <div className="album-title">
                          <strong>FPT POLYTECHNIC</strong> create new{" "}
                          <span>album</span>
                        </div>
        ...
        <div className={checkSideRight ? "right-side" : "right-side active"}>
        ...
        <div
          className={
            checkOverlay === "right"
              ...
              : checkSideLeft
              ? "overlay"
              : "overlay active leftSide"
          }
          onClick={handleCloseSideAll}
          // className="{ 'active': rightSide || leftSide }"
        ></div>
      </div>
    </body>
  );
